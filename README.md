...
Una lista sea crea con [] separando sus elementos con comas " , ". A continuación un ejemplo:
```python
lista = [10, "Bryan", 3.67, [1, 6, 9]]                      #[10, 'Bryan', 3.67, [1, 2, 3]]
#O también puede crearse una lista de la siguiente manera:
lista = list("123456789b")                           #['1', '2', '3', '4', '5', '6', '7', '8', '9', 'b']
print(lista)
```
## Tuple
